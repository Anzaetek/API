...
def queryDone20(res: MLInferenceSolution) -> None:
    ...
    pqueryQUBOSolverProblem("https://api2.anzaetek.com:443/execute", q20_2, queryDone20_2)
    ...
    if False:
      ...
      pqueryQUBOSolverProblem("https://api2.anzaetek.com:443/execute", q20_3, queryDone20_2)
...
pqueryMLInferenceProblem("https://api2.anzaetek.com:443/execute", q20, queryDone20)
