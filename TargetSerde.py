...
def makeSolverProblemSerde(p: SolverProblem) -> SolverProblemSerde:
    ...
    return SolverProblemSerde(makeTargetSerde(p.Description), p.DescriptionString, p.DescriptionSymbolList, p.DescriptionParameters, p.Config, p.Info)

def makeSolverProblem(p: SolverProblemSerde) -> SolverProblem:
    sp = SolverProblem(makeTarget(p.Description), p.DescriptionString, p.DescriptionSymbolList, p.DescriptionParameters, p.Config, p.Info)
